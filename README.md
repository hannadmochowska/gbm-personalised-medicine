...
p53
DNA-damage response
HR = 0.78, p = 0.065 (borderline)
HR = 0.98, p = 0.982 (did not replicate)
Rb-E2F
Cell-cycle restriction point
Clean null (all 20 features p > 0.3)
Not pursued, no discovery signal
RTK/PI3K/MAPK
Growth-factor signalling
Clean null (all 20 features HR ≈ 1)
Not pursued, no discovery signal
...
Role
Patients used
TCGA-GBM (PanCancer Atlas 2018)
gbm_tcga_pan_can_atlas_2018
Discovery, all 3 models
154
CPTAC-GBM (Wang et al., Cancer Cell 2021)
gbm_cptac_2021
Validation, p53 model only
96
...
preprocessing/GBM_p53_preproc.R
models/GBM_p53_model.ipynb
analysis/GBM_Analysis.R

p53 (CPTAC validation, run after the TCGA step above):

preprocessing/CPTAC_p53_preproc.R
models/CPTAC_p53_model.ipynb
analysis/CPTAC_Q1_validation.R

Rb-E2F (TCGA discovery):

preprocessing/GBM_RbE2F_preproc.R
models/GBM_RbE2F_model.ipynb
analysis/GBM_RbE2F_TCGA_discovery.R

RTK/PI3K/MAPK (TCGA discovery):

preprocessing/GBM_Pappalardo_preproc.R
models/GBM_Pappalardo_model.ipynb
analysis/GBM_Pappalardo_TCGA_discovery.R
Dependencies
