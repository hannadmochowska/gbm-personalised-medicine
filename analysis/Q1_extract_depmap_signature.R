# Q1 — Extract the DepMap/GDSC2 TMZ-Sensitivity Score
#
# Purpose: GBM_cellline_coefs.csv is a 10-gene LASSO signature trained on
# GDSC2 temozolomide response in DepMap GBM cell lines. This script projects
# it onto both patient cohorts using each patient's own z-scored expression,
# so it can be added as one more candidate feature in
